...
def CalcularError (kTiempo):
    ...
    que el resultado exacto del problema es 10 * sqrt(10)
...
def EjecutarNewtonRaphson (kTiempo):
    ...
    Parámetros de la función:
    ------------------------
    kTiempo: Tiempo inicial para el cálculo con el método de Newton-Raphson.

    Salida de la función:
    ---------------------
    Tiempo: Momento en el que el móvil se encuentra en la posición 0 con un error máximo de 1%
    """
    error = 1
    iContador = 1
